...
public class AgendaController implements Serializable {
    ...
    @EJB
    private ufsc.trabalho.controller.AgendaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addErrorMessage(new Exception("Não pode cadastrar medico para este dia!"), ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
        }
    }
    ...
    public static class AgendaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Agenda) {
                ...
                return getStringKey(o.getDiaDaSemana());
            } else {
    ...
    public List<SelectItem> getComboDiasDaSemana(){
        List<SelectItem> items =new ArrayList<SelectItem>();
        
        items.add(new SelectItem(0, "Domingo"));
        items.add(new SelectItem(1, "Segunda"));
        items.add(new SelectItem(2, "Terça"));
        items.add(new SelectItem(3, "Quarta"));
        items.add(new SelectItem(4, "Quinta"));
        items.add(new SelectItem(5, "Sexta"));
        items.add(new SelectItem(6, "Sábado"));
