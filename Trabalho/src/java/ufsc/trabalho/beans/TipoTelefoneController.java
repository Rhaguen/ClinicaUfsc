...
import ufsc.trabalho.model.TipoTelefone;
import ufsc.trabalho.beans.util.JsfUtil;
import ufsc.trabalho.beans.util.PaginationHelper;
import ufsc.trabalho.controller.TipoTelefoneFacade;
...
@ManagedBean(name = "tipoTelefoneController")
@SessionScoped
public class TipoTelefoneController implements Serializable {
    ...
    @EJB
    private ufsc.trabalho.controller.TipoTelefoneFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoTelefoneCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoTelefoneUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TipoTelefoneDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
